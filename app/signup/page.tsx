  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black text-white p-4">
      ...
      <div className="fixed inset-0 z-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-purple-500/20 rounded-full blur-[120px] opacity-50" />
      </div>
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm">Join the premium digital vault</p>
        </div>
